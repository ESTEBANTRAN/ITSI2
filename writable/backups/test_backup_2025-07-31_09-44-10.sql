...
INSERT INTO `becas` VALUES (1,'Beca Excelencia Académica','Beca para estudiantes con excelente rendimiento académico','Promedio mínimo de 9.0, sin materias reprobadas',9.00,1),(2,'Beca Socioeconómica','Beca para estudiantes con necesidades económicas','Ficha socioeconómica aprobada, promedio mínimo de 7.5',7.50,1),(3,'Beca Deportiva','Beca para deportistas destacados','Participación activa en equipos deportivos, promedio mínimo de 7.0',7.00,1),(4,'Beca Cultural','Beca para estudiantes con talentos culturales','Participación en actividades culturales, promedio mínimo de 7.0',7.00,1);
...
CREATE TABLE `citas` (
  ...
  CONSTRAINT `citas_ibfk_1` FOREIGN KEY (`ticket_id`) REFERENCES `tickets_atencion` (`id`) ON DELETE SET NULL,
  CONSTRAINT `citas_ibfk_2` FOREIGN KEY (`estudiante_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
  CONSTRAINT `citas_ibfk_3` FOREIGN KEY (`admin_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
...
CREATE TABLE `fichas_becas_relacion` (
  ...
  KEY `solicitud_beca_id` (`solicitud_beca_id`),
  CONSTRAINT `fk_fichas_becas_ficha` FOREIGN KEY (`ficha_id`) REFERENCES `fichas_socioeconomicas` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_fichas_becas_solicitud` FOREIGN KEY (`solicitud_beca_id`) REFERENCES `solicitudes_becas` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fichas_socioeconomicas` (
  ...
  CONSTRAINT `fichas_socioeconomicas_ibfk_1` FOREIGN KEY (`estudiante_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fichas_socioeconomicas_ibfk_2` FOREIGN KEY (`periodo_id`) REFERENCES `periodos_academicos` (`id`)
...
INSERT INTO `periodos_academicos` VALUES (1,'2024-1','2024-03-01','2024-08-31',0,0,1,1,3000,3000,1,0,''),(2,'2024-2','2024-09-01','2025-01-31',1,1,1,1,100,50,2,1,NULL),(3,'2025-1','2025-02-01','2025-08-31',1,1,1,1,3000,3000,0,0,''),(4,'PERIODO 2026','2025-07-30','2026-07-31',1,1,1,1,3000,274,1,0,'funcionando'),(5,'PERIODO 2025','2024-07-01','2024-07-31',0,0,1,1,3000,3000,0,0,''),(6,'2024-1','2024-01-15','2024-06-15',0,0,1,0,1000,200,0,0,'Primer período 2024'),(7,'2024-2','2024-07-15','2024-12-15',1,1,1,1,1000,200,3,2,'Segundo período 2024'),(8,'2025-1','2025-01-15','2025-06-15',0,0,1,0,1200,250,0,0,'Primer período 2025'),(10,'2024-1','2024-01-15','2024-06-15',0,0,1,0,1000,200,0,0,'Primer período 2024'),(11,'2024-2','2024-07-15','2024-12-15',1,1,1,1,1000,200,0,0,'Segundo período 2024'),(12,'2025-1','2025-01-15','2025-06-15',0,0,1,0,1200,250,0,0,'Primer período 2025');
...
CREATE TABLE `respaldos` (
  ...
  CONSTRAINT `respaldos_ibfk_1` FOREIGN KEY (`creado_por`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL
...
CREATE TABLE `respuestas_solicitudes` (
  ...
  KEY `usuario_id` (`usuario_id`),
  CONSTRAINT `respuestas_solicitudes_ibfk_1` FOREIGN KEY (`solicitud_id`) REFERENCES `solicitudes_ayuda` (`id`) ON DELETE CASCADE,
  CONSTRAINT `respuestas_solicitudes_ibfk_2` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE
...
CREATE TABLE `solicitudes_ayuda` (
  ...
  CONSTRAINT `fk_solicitud_estudiante` FOREIGN KEY (`id_estudiante`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_solicitud_responsable` FOREIGN KEY (`id_responsable`) REFERENCES `usuarios` (`id`) ON DELETE SET NULL ON UPDATE CASCADE
...
INSERT INTO `solicitudes_ayuda` VALUES (2,3,'Apoyo psicológico','He estado pasando por momentos difíciles y necesito apoyo psicológico para continuar con mis estudios.','2024-10-05 11:00:00','Pendiente','Alta','2024-10-05 11:00:00',NULL),(3,41,'Orientación académica','Necesito orientación sobre mi carrera y opciones de especialización','2024-08-05 14:30:00','Resuelta','Media','2024-08-07 10:15:00',44),(4,42,'Dificultades académicas','Tengo dificultades con matemáticas y necesito apoyo','2024-08-15 16:45:00','Pendiente','Alta','2024-08-15 16:45:00',NULL),(5,43,'Problemas económicos','Mi familia está pasando por dificultades económicas','2024-08-10 12:20:00','En Proceso','Urgente','2024-08-12 09:30:00',44),(6,3,'Orientación académica','Necesito orientación sobre mi carrera y opciones de especialización','2025-07-26 02:36:32','Resuelta','Media','2025-07-28 02:36:32',7),(7,40,'Dificultades académicas','Tengo dificultades con matemáticas y necesito apoyo','2025-07-27 02:36:32','Pendiente','Alta','2025-07-27 02:36:32',NULL),(8,39,'Problemas económicos','Mi familia está pasando por dificultades económicas','2025-07-28 02:36:32','En Proceso','Urgente','2025-07-29 02:36:32',7);
...
CREATE TABLE `solicitudes_becas` (
  ...
  CONSTRAINT `solicitudes_becas_ibfk_1` FOREIGN KEY (`estudiante_id`) REFERENCES `usuarios` (`id`) ON DELETE CASCADE,
  CONSTRAINT `solicitudes_becas_ibfk_2` FOREIGN KEY (`beca_id`) REFERENCES `becas` (`id`),
  CONSTRAINT `solicitudes_becas_ibfk_3` FOREIGN KEY (`periodo_id`) REFERENCES `periodos_academicos` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2025-07-31  2:44:10
